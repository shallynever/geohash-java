...
public class GeoHashTest {
    ...
    public void testDecode() {
        ...
        for (GeoHash gh : RandomGeohashes.fullRange()) {
            ...
            assertTrue("bbox " + bbox + " should contain the decoded center value " + decodedCenter, bbox.contains(decodedCenter));
    ...
    @Test
    public void check() {
        GeoHash geoHash = GeoHash.withCharacterPrecision(30.347278203674, 120.10151503789, 7);
    ...
    public void testOrdIsPositive() {
        ...
        GeoHash geoHash = GeoHash.fromLongValue(hash.ord(), hash.significantBits);
